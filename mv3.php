...
<html>
    ...
    <body>
        <div class="first">
            ...
            <div class="oppo">
                <h1>Oppo F25 Pro 5G</h1>
                <h2>&#11088;4.1/5</h2>42 ratings
                <h3>200+ bought in past month</h3>
                <h2 style="color:red;">-17% &#8377;23,999</h2>
                <h4>M.R.P.:<strike>&#8377;28,999</strike></h4>
                <h5>Inclusive of all taxes</h5>
                <h5>EMI starts at &#8377;1,164. No Cost EMI available</h5> 
    ...
    <form action="booknow.php" id="bookingForm" method="post">
        ...
        <div class="button-style">
            ...
            ?>
            <input type="hidden" name="model" value="Oppo F25 Pro 5G">
            <input type="hidden" name="date" value="<?php echo $date ?>">
            <input type="hidden" name="time" value="<?php echo $time ?>">
            <input type="hidden" name="cost" value="23,999"> 
