...
<html>
    ...
    <body>
        <div class="first">
            <div class="image">
                <img src="https://m.media-amazon.com/images/I/61VbKHdE0rL._SX679_.jpg" height="100%"  alt="">
            </div>
            <div class="iqoo">
                <h1>iQOO Z6 Lite 5G</h1>
                <h2>&#11088;4.1/5</h2>21,916 ratings
                <h3>5k+ bought in past month</h3>
                <h2 style="color:red;">-43% &#8377;11,499</h2>
                <h4>M.R.P.:<strike>&#8377;19,999</strike></h4>
                <h5>Inclusive of all taxes</h5>
                <h5>EMI starts at &#8377;557. No Cost EMI available</h5> 
    ...
    <form action="booknow.php" id="bookingForm" method="post">
        ...
        <div class="button-style">
            ...
            ?>
            <input type="hidden" name="model" value="iQOO Z6 Lite 5G">
            <input type="hidden" name="date" value="<?php echo $date ?>">
            <input type="hidden" name="time" value="<?php echo $time ?>">
            <input type="hidden" name="cost" value="11,499"> 
                ...
                <div class="details">
                    <table style="color: white;font-size: larger;" border="0" width="100%" cellspacing="4" cellpadding="10">
                        ...
                        <tr>
                            ...
                            <td>
                                <h3>Funtouch OS 12 based on Android 12</h3>
                            </td>
                        </tr>
                        <tr>
                            <th>
