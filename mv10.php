...
<html>
    ...
    <body>
        <div class="first">
            <div class="image">
                <img src="https://m.media-amazon.com/images/I/61BAuSC0UnL._SX679_.jpg" height="100%"  alt="">
            </div>
            <div class="oneplus">
                <h1>OnePlus 12</h1>
                <h2>&#11088;4.5/5</h2>687 ratings
                <h3>300+ bought in past month</h3>
                <h2 style="color:red;">-10% &#8377;69,999</h2>
                <h4>M.R.P.:<strike>&#8377;62,999</strike></h4>
                <h5>Inclusive of all taxes</h5>
                <h5>EMI starts at &#8377;3,394. No Cost EMI available</h5> 
    ...
    <form action="booknow.php" id="bookingForm" method="post">
        <table style="color: white; border-color: white; font-size: large;" border="1" cellpadding="15" cellspacing="4" width="100%">
            ...
            <tr>
                <th style="color: rgba(76,101,98,255);">
                    <h2>Flowey Emerald</h2>
                </th>
                <th style="font-size: x-large;">
                <input type="radio" value="8 GB+256 GB" name="size" checked="true">8 GB+256 GB &nbsp; 
                    <input type="radio" value="16 GB+256 GB" name="size">16 GB+256 GB &nbsp;
        ...
        <div class="button-style">
            ...
            ?>
            <input type="hidden" name="model" value="OnePlus 12">
            <input type="hidden" name="date" value="<?php echo $date ?>">
            <input type="hidden" name="time" value="<?php echo $time ?>">
            <input type="hidden" name="cost" value="69,999"> 
