...
<html>
    ...
    <body>
        <div class="first">
            <div class="image">
                <img src="https://m.media-amazon.com/images/I/81QvAGRjTAL._SY879_.jpg" height="100%"  alt="">
            </div>
            <div class="realme">
                <h1>realme 12 Pro 5G</h1>
                <h2>&#11088;3.9/5</h2>67 ratings
                <h3>1k+ bought in past month</h3>
                <h2 style="color:red;">-24% &#8377;24,429</h2>
                <h4>M.R.P.:<strike>&#8377;31,999</strike></h4>
                <h5>Inclusive of all taxes</h5>
                <h5>EMI starts at &#8377;1,180. No Cost EMI available</h5> 
    ...
    <form action="booknow.php" id="bookingForm" method="post">
        <table style="color: white; border-color: white; font-size: large;" border="1" cellpadding="15" cellspacing="4" width="100%">
            ...
            <tr>
                <th style="color: rgb(52,78,115);">
                    <h2>Submarine Blue</h2>
                </th>
        ...
        <div class="button-style">
            ...
            ?>
            <input type="hidden" name="model" value="realme 12 Pro 5G">
            <input type="hidden" name="date" value="<?php echo $date ?>">
            <input type="hidden" name="time" value="<?php echo $time ?>">
            <input type="hidden" name="cost" value="24,429"> 
