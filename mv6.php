...
<html>
    ...
    <body>
        <div class="first">
            <div class="image">
                <img src="https://m.media-amazon.com/images/I/71NnrsYP63L._AC_UY327_FMwebp_QL65_.jpg" height="100%"  alt="">
            </div>
            <div class="redmi">
                <h1>Redmi Note 13 5G</h1>
                <h2>&#11088;3.5/5</h2>1,753 ratings
                <h3>1k+ bought in past month</h3>
                <h2 style="color:red;">-13% &#8377;19,999</h2>
    ...
    <form action="booknow.php" id="bookingForm" method="post">
        <table style="color: white; border-color: white; font-size: large;" border="1" cellpadding="15" cellspacing="4" width="100%">
            ...
            <tr>
                ...
                <th style="font-size: x-large;">
                    ...
                    <input type="radio" value="12 GB+256 GB" name="size">12 GB+256 GB &nbsp;
                </th>
            </tr>
        </table>
        <div class="button-style">
            ...
            ?>
            <input type="hidden" name="model" value="Redmi Note 13 5G">
